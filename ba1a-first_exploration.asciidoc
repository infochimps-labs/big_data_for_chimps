...
* _Text Analysis_ -- extract meaning from free text; here, it's the geographic context of words, but it could be 
* _Geographic Analysis_ -- spatial relationships among objects: word 
uncovering an epidemic from disease reports, or visitors to your website
