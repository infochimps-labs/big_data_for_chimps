...
TODO: I (qem) would nix the Exercise sections, unless you have them in every chapter.  Hmm, or, leave this in a sidebar.  Yes, sidebar sounds good.
...
TODO: (qem) I vote to either nix this section, or put it in a prose form in a sidebar or note.  "We've just barely touched on joins.  Here are some other angles to consider..."
