...
* `io.sort.mb` default `X`, recommended `1.5 * typical output size`. You can devote up to 70% of the child heap size to this value; you should always use a bit more than the block size.
