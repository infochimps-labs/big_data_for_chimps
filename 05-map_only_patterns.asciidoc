...
.Pig - Projecting Only Chosen Columns by Name (ch_04/data_elimination.pig)
------
...
.Pig - Altering Column Names (ch_04/data_elimination.pig)
------
...
.Pig - Sampling Data (ch_04/data_elimination.pig)
------
...
.Pig - Extracting a Consistent Sample (ch_04/data_elimination.pig)
------
...
.Pig - Selecting N Arbitrary Records (ch_04/data_elimination.pig)
------
...
.Pig - FOREACH Example One (ch_04/foreach.pig)
------
...
.Pig - Nested FOREACH (ch_04/foreach.pig)
------
...
.Pig - Formatting Strings (ch_04/foreach.pig)
------
...
.Pig - Assembling Complex Types (ch_04/foreach.pig)
------
...
.Pig - Assembling Very Complex Types (ch_04/foreach.pig)
------
...
.Pig - Manipulating Field Types (ch_04/types.pig)
------
birthplaces = FOREACH people GENERATE
    player_id,
...
.Pig - Managing Floating Point Schemas (ch_04/types.pig)
------
...
[source,pig]
.Pig - REGISTERing jars and Using UDFs (ch_04/udf.pig)
------
...
[source,pig]
.Pig - Splitting Relations (ch_04/split_union.pig)
----
SPLIT bat_seasons
