...
You now have enough information about baseball and its metrics to work through the examples in this book. If you're a baseball fan, feel free to filter the examples to tell stories about your favorite team. In the next section of the book, we'll use baseball examples to teach analytic patterns - those operations which enable most kinds of analysis.
