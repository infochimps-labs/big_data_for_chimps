...
* Build your regular expressions to be 'good brittle'. If you only expect IP addresses to be numbers with dots, make your program reject records that 
...
Here's the <<serverlogs_output_parser_map,output of this script>> in local mode:
...
----
include::code/serverlogs/logline-00-model-day_hr.rb[]
----
