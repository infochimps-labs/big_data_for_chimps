...
* Wikipedia English-language Article Corpus (`wikipedia_corpus`; 38 GB, 619 million records, 4 billion tokens): the full text of every English-language wikipedia article, in JOEMAN:HS

* Wikipedia Pagelink Graph (`wikipedia_pagelinks`; ) -- JOEMAN:HS
