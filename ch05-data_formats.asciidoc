...
If you have to emit XML for downstream consumption, yet have any control over its structure, follow these best practices: 
    ...
    <post>
      ...
      <dtstart>2012-01-02T12:34:56 CST</dtstart>
      <text>I have eaten&#10;the plums&#10;that were in&#10;the icebox&#10;&#10;and which&#10;you were probably&#10;saving&#10;for breakfast&#10;&#10;Forgive me&#10;they were delicious&#10;so sweet&#10;and so cold</text>
      <comments>
        <comment><author>Holly</author><id>98765</id><text>Your poem made up for it...  &lt;em&gt;barely&lt;/em&gt;</text></comment>
      </comments>
      <replies></replies>
    </post>
    --------------------
...
* **It doesn't preserve complex types**: there's no
  - mixed attributes and data:

    --------------------
    <post date="2012-01-02T12:34:56 CST" author="adam"><body>I just had a bacon sandwich</body></post>`
    --------------------

    - mixed data and text:

    --------------------
    <post><title>Great News!</title>I <span dtstart="2012-01-02T12:34:56 CST">just</span> had a bacon sandwich!</post>`
    --------------------
...
* **inconsistent cardinality**:
    ...
    <post>
      ...
      <text>I just had a bacon sandwich!</text>
      <comment><author>Holly</author><text>Mmmmm...</text></comment>
    </post>
    --------------------
...
* **it's fiendishly complex to do right**: the technical standard for XML is fiendishly complex, and even mature libraries in widespread use still report bugs parsing complex or ill-formed input.

footnote:[there are no CDATA blocks; tags hold data or other tags, not both; values are only in tag bodies, and not also in tag attributes]
