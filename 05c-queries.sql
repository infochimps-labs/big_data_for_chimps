...
To generate all the three-letter combinations of a-z,

----
intstable_all = LOAD '.../intstable.tsv' AS (num:long);
intstable = FILTER intstable_all BY num < (10000);
char3s = FOREACH intstable GENERATE num * num;
...
-- Earlier we selected players who made the all-star team based on their career totals.
