...
----
{{ d['code/munging/airline_flights/airline_flights.rake-airports:parse:dataexpo|rake2|snippet|wulign'] }}
----

----
{{ d['code/munging/airline_flights/airline_flights.rake|rake|snippet|wulign'] }}
----
