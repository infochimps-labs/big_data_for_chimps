...
player_careers = FOREACH (GROUP bat_year BY player_id) {
  ...
  GENERATE group AS player_id,
    ...
    MIN(year_id) AS beg_year, MAX(year_id) AS end_year,
    BagToString(team_ids, '|'),
