...
They should be identical to the output of the local execution:
...
The difference being that the Hadoop execution on a large cluster could scale to petabytes of UFO sightings!
