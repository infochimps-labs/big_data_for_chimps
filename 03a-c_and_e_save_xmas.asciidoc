...
//// I'd finish this paragraph with a tie-in to the real-world, like, "...Again, just as a scientist would..."  Amy////
...
The chimps' job was to take letters one-by-one from a mailbag, and fill out a toyform for each requested toy. A toyform has a prominent label showing the type of toy, and a body with all the information you'd expect: Name, Goodness, Location, and so forth. Here are some simplified examples:
